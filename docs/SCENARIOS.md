...
**Required evidence:** exact rows and exceptions at both cut-offs, latest consent selection and historical exclusion after withdrawal. Live completion by 07:00 UTC, fresh required deliveries and an observed alert remain deployment acceptance items.
...
**Required evidence:** exact aggregates, a corrected interaction's obsolete product removed, multi-product calls counted correctly, current hierarchy change visible, unknown references excluded and flagged. Live completion by 06:30 UTC remains open.
...
**Required evidence:** 99 active-customer rows in Crawl, one flagged missing assignment, the deliberate September realignment winning, the October assignment ignored and a test proving equal-date conflicts fail. XLSX-to-CSV byte equality is also checked.
...
**Required evidence:** historical bootstrap, exact duplicate, correction, tombstone, seven/eight-day boundary, missing date, reorder/replay, equal-version conflict. The fixture ends with 301 trusted interactions.
...
**Required evidence:** 59 matched member rows across three noncancelled campaigns, retained zero counts, product/date qualification, cancelled-campaign exclusion and the 5% boundary. Weekly scheduling remains open.
